...
class AuthorListViewTest(TestCase):
    ...
    def bad_user_dict(self):
        return dict(email='bad@user.com', username='', first_name='Test', last_name='User',
        password='', bio='abc')

    def user_dict(self):
        return dict(email='test@user.com', username='testuser', first_name='Test', last_name='User',
        password='Testuser123', bio='abc')
